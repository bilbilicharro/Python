...
suma_de_listas.remove(
    5
)  # Aqui removi el item por su valor, odseaa el nuumero 1 fue removido de la lista
del suma_de_listas[2]  # Aqui he removido el tercer item por indice
